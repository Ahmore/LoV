	...
	var ColorPicker = function () {
		var
			...
			change = function (ev) {
				...
				cal.data('colorpicker').onChange.apply(cal.data('colorpicker').el, [HSBToHex(col), col, HSBToRGB(col)]);
			},
			blur = function (ev) {
				var cal = $(this).parent().parent();
			...
			downIncrement = function (ev) {
				...
				$(document).on('mousedown', current, moveIncrement);
			},
			...
			upIncrement = function (ev) {
				...
				$(document).off('mousedown', moveIncrement);
				return false;
			},
			downHue = function (ev) {
				var current = {
				...
				$(document).on('mousedown', current, moveHue);
			},
			moveHue = function (ev) {
				change.apply(
			...
			upHue = function (ev) {
				...
				$(document).off('mousedown', moveHue);
				return false;
			},
			downSelector = function (ev) {
				...
				$(document).on('mousedown', current, moveSelector);
			},
			...
			upSelector = function (ev) {
				...
				$(document).off('mousedown', moveSelector);
				return false;
			},
